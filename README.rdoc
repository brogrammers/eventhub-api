...
you need an App ID and App Secret. Those two pieces of information
allow us to indentify each application using Eventhub API.
...
3. You will be presented with your newly genreated App ID & Secret. Save them. If you foget what they were,
just go back to http://localhost:3000/oauth/applications, it will be listed there.
...
3. After you send the request and all the data is valid you should see a following JSON response :
